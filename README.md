...
> このページを開く [https://kakuritu-p.github.io/chat-p/](https://kakuritu-p.github.io/chat-p/)
...
* **https://github.com/kakuritu-p/chat-p** を検索してインポートします。
...
* **https://github.com/kakuritu-p/chat-p** を貼り付けてインポートをクリックしてください
